...
const Dashboard = () => {
 ...
 <div className="tw-bg-gray-50">
        <div className="tw-max-w-7xl tw-mx-auto tw-py-12 tw-px-4 sm:tw-px-6 lg:tw-py-16 lg:tw-px-8 lg:tw-flex lg:tw-items-center lg:tw-justify-between">
          <h2 className="tw-text-3xl tw-font-extrabold tw-tracking-tight tw-text-gray-900 sm:tw-text-4xl">
            ...
            <span className="tw-block tw-text-indigo-600">Start your free trial today.</span>
          </h2>
          <div className="tw-mt-8 tw-flex lg:tw-mt-0 lg:tw-flex-shrink-0">
            <div className="tw-inline-flex tw-rounded-md tw-shadow">
              <a href="#" className="tw-inline-flex tw-items-center tw-justify-center tw-px-5 tw-py-3 tw-border tw-border-transparent tw-text-base tw-font-medium tw-rounded-md tw-text-white tw-bg-indigo-600 hover:tw-bg-indigo-700">
                Get started
              </a>
            </div>
            <div className="tw-ml-3 tw-inline-flex tw-rounded-md tw-shadow">
              <a href="#" className="tw-inline-flex tw-items-center tw-justify-center tw-px-5 tw-py-3 tw-border tw-border-transparent tw-text-base tw-font-medium tw-rounded-md tw-text-indigo-600 tw-bg-white hover:tw-bg-indigo-50">
                Learn more
              </a>
            </div>
          </div></div></div>
              ...
              <table className="table table-hover table-outline mb-0 d-none d-sm-table">
                ...
                <tbody>
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="c-avatar">
                        <img src={'avatars/gepeto.jpg'} className="c-avatar-img" alt="admin@bootstrapmaster.com" />
                        <span className="c-avatar-status bg-danger"></span>
                      </div>
                    </td>
                    <td>
